...
void *logVariables(void *Thread_Number)
{
    ...
    std::ofstream outFile("/home/ani/Documents/Runtime_Verification/CS632_2025_assignment5/Tooled_SUV/output_from_tooled_SHED.txt");
    ...
    while (logging_active)
    {
        ...
        string data = to_string(sample_index) + "," +
            ...
            to_string(Steel_Shed) + "," + 
            to_string(Coal_Shed) + "," + 
                      to_string(num_of_shed);
