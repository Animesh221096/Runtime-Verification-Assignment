...
void *logVariables(void *Thread_Number)
{
    ...
    int sample_index = 0;
    int sockfd = create_socket("ani-Dell-G15-5510", 51717);                                                                     // Change to your server's hostname and port
    std::ofstream outFile("/home/ani/Documents/Runtime_Verification/CS632_2025_assignment4/Tooled_SUV/output_from_tooled.txt"); // Create an output file stream
